...
def retrieve(
    query: Annotated[str, "The search query string to retrieve information for."]
):
    ...
    Given a query that requires retrieval, you call the retrieval function to get a list of results.
    """
